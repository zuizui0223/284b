# Ecology Letters Method compliance checklist v0.4

Checked against current Ecology Letters/Wiley author guidance and the Method editorial; scientific routing updated after the relation-layer separation audit.
...
- rationale: `manuscript/ECOLOGY_LETTERS_METHOD_PROPOSAL_V0_7.md`;
...
- updated antecedent audit: `manuscript/CLOSER_ANTECEDENT_AUDIT_V0_4.md`.
...
Canonical full-submission scientific package remains:
...
The relation-layer separation argument is new **method evidence**, not a new empirical endpoint. It may be integrated into the invited manuscript as a short architecture paragraph/inset without changing Level-A/B/C status.
