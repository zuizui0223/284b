# Ecology Letters submission manifest v0.4

This is the single routing surface for the reviewer-hardened pre-field Paper 1 after the relation-layer separation audit. Older proposal/manuscript/title-page/compliance/ledger versions remain provenance only unless explicitly re-promoted.
...
- proposal rationale: `manuscript/ECOLOGY_LETTERS_METHOD_PROPOSAL_V0_7.md`;
- email wrapper: `manuscript/ECOLOGY_LETTERS_PROPOSAL_EMAIL_V0_4.md`;
- one attachment: `manuscript/figures/ecology_letters_method_proposal_figure_v0_5.svg`;
- compliance gate: `manuscript/ECOLOGY_LETTERS_COMPLIANCE_V0_4.md`;
...
The full manuscript remains v0.7 until invitation. The separation argument is method evidence that can be integrated as a short architecture paragraph/inset during final invited-manuscript formatting without altering the frozen empirical state.
...
Empirical ledger remains **1**. Relation-layer separation increment = 0.
...
- proposal rationales before v0.7;
- proposal email wrappers before v0.4;
- compliance checklists before v0.4;
- submission manifests before v0.4.
