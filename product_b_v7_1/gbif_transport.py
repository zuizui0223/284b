"""Authorized GBIF transport for the JOS001 USA engineering occurrence preflight."""
...
class AuthorizedV71GBIFSearchTransport:
    ...
    def _fetch_payload(self, endpoint: str, params: Mapping[str, str]) -> Mapping[str, object]:
        request = Request(
            ...
            headers={
                ...
                "User-Agent": "zuizui0223-284b-product-b-v7-1-jos001/0.1",
            },
            method="GET",
        )
    ...
    def __call__(self, query: LogicalOccurrenceQuery) -> tuple[Mapping[str, object], ...]:
        request = serialize_v7_1_gbif_search_request(query)
        ...
        while request is not None:
            ...
            for row in page_rows:
                ...
                rows.append(row)
            pages += 1
            request = next_v7_1_search_request(query, envelope)
