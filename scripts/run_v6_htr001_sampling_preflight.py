#!/usr/bin/env python3
"""Run the authorized Product-B v6 HTR001 sampling/control preflight once.

Raw GBIF rows remain in memory. The persisted artifact contains only transport and
sampling audits. This runner never opens invariant/model/process-knockout outputs.
"""
...
from product_b_v6.htr001_execution import execute_htr001_sampling_preflight
...
OUTPUT_PATH = ROOT / "artifacts/product_b_v6_htr001_sampling_preflight.json"
