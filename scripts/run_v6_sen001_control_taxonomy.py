#!/usr/bin/env python3
"""Resolve the frozen SEN001 shuffled-host pool without occurrence access."""
...
CONTRACT_PATH = ROOT / "config/product_b_v6_sen001_control_taxonomy_v0_1.json"
OUTPUT_PATH = ROOT / "artifacts/product_b_v6_sen001_control_taxonomy.json"
...
def _get_json(url: str, *, timeout_seconds: float = 60.0) -> Mapping[str, object]:
    request = Request(
        ...
        headers={
            ...
            "User-Agent": "zuizui0223-284b-product-b-v6-control-taxonomy/0.1",
        },
        method="GET",
    )
