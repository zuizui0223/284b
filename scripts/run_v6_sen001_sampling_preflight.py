#!/usr/bin/env python3
"""Run the authorized Product-B v6 SEN001 sampling/control preflight once.
...
from product_b_v6.execution import execute_sen001_sampling_preflight
...
OUTPUT_PATH = ROOT / "artifacts/product_b_v6_sen001_sampling_preflight.json"
