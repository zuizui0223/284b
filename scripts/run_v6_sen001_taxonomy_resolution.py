#!/usr/bin/env python3
"""Resolve v6 SEN001 taxonomy without opening occurrences."""
...
CONTRACT_PATH = ROOT / "config/product_b_v6_sen001_taxonomy_resolution_v0_1.json"
OUTPUT_PATH = ROOT / "artifacts/product_b_v6_sen001_taxonomy_resolution.json"
