#!/usr/bin/env python3
"""Run the authorized Product-B v7 KIM001 host/control sampling preflight once."""
...
from product_b_v7.gbif_transport import AuthorizedV7GBIFSearchTransport
from product_b_v7.kim001_execution import execute_kim001_sampling_preflight

ROOT = Path(__file__).resolve().parents[1]
MANIFEST_PATH = ROOT / "config/product_b_v7_kim001_execution_manifest_v0_1.json"
OUTPUT_PATH = ROOT / "artifacts/product_b_v7_kim001_sampling_preflight.json"
...
def main() -> int:
    ...
    transport = AuthorizedV7GBIFSearchTransport(timeout_seconds=90.0)
    outcome: dict[str, Any] = {
        ...
        "literature_witness_occurrence_reads_opened": False,
    ...
    exit_code = 0
    try:
        result = execute_kim001_sampling_preflight(manifest=manifest, transport=transport)
        outcome.update({
            "status": "completed",
