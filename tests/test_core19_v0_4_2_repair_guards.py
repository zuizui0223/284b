...
class Core19V042RepairGuards(unittest.TestCase):
    def test_serialization_repair_is_successor_only_and_outcome_blind(self):
        ...
        self.assertIn("result_version':'product_b_same_target_core19_fit_audit_v0.4.2", w)
        self.assertIn("'successor_sealed_fit_cells':succ_sealed", w)
        self.assertIn("'heldout_artifacts_inherited_from_parent_refit':True", w)
    ...
    def test_reference_requires_repaired_exact_audit_not_parent_failed_audit(self):
        ...
        self.assertIn('product-b-core19-v0-4-2-fit-audit', w)
