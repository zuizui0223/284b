...
def test_manifest_explicitly_supersedes_old_stage1_versions():
    ...
    assert "proposal rationales before v0.7" in section
    assert "proposal email wrappers before v0.4" in section
    assert "compliance checklists before v0.4" in section
    assert "submission manifests before v0.4" in section
